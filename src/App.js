...
import { Navbar, NavItem, Nav, Grid, Row, Col, Container } from "react-bootstrap";
const PLACES = [
  { name: "Palo Alto", zip: "94301" },
  { name: "San Jose", zip: "94088" },
  { name: "Santa Cruz", zip: "95062" },
  { name: "Luybertsy", zip: "109153" },
  { name: "Honolulu", zip: "96803" },
  { name: "Gzhel", zip: "140165" }
];
class App extends Component  {
  ...
  sendZip(e){
    if (e.keyCode === 13) {
      ...
      const newCity = {name:'Ваш выбранный город', zip: e.target.value}

      PLACES.push(newCity)
      this.setState({newZipCode:1} )
    }
      return
  }
  render(){
    let activePlace = this.state.activePlace
    return (
      <div className="App">
    ...
    <Navbar.Brand cla>
      ...
      />{' '}
      Личный Агрегатор Погоды 
    </Navbar.Brand>
    </Navbar>
<Container>
  <Row>
    <Col xs="5"  className="navItem">
    <Nav variant="pills" className="flex-column" >
        ...
        <input type="text" maxLength="6" onKeyDown={(e) => this.sendZip(e)} />
        </Nav>
    </Col>
    <Col xs="7">
    <WeatherApp key={activePlace} zip={PLACES[activePlace].zip} />
    </Col>
  </Row>
